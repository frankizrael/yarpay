<footer>
  <div class="x-container">
    <div class="list-footer">
      ...
      <div class="item-footer">
        <h2><?php the_field('title_ayudamos','options'); ?></h2>
        <div class="menu-f">
          <?php wp_nav_menu( array( 'theme_location' => 'ayuda-menu' ) ); ?>  
        </div>
      </div>
      <div class="item-footer">
        <h2><?php the_field('title_novedades','options'); ?></h2>
        <div class="subscripb">
          <?php echo do_shortcode('[contact-form-7 id="18" title="subscripcion"]'); ?>
        </div>
        <div class="social">
          <span><?php the_field('title_siguenos','options'); ?></span>
          <div class="social-int">
            <?php
              $social = get_field('social','options');
              foreach ($social as $s) {
                ?>
                <a href="<?php echo $s['link']; ?>"><img src="<?php echo $s['imagen']; ?>"></a>
                <?php
              }
            ?>
          </div>
...
<div class="ModalLeft">
  <div class="ModalLeft__close"></div>
  <div class="ModalLeft__tab">
    <ul>
      <li class="tab_perfil" data="perfil" redirect="<?php if ( is_user_logged_in() ) { ?> <?php echo site_url();?>/mi-perfil <?php } ?>">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="14.26" height="14.26" viewBox="0 0 14.26 14.26"><defs><style>.cls-ww-1{fill:#fff}</style></defs><g id="user" transform="translate(-6 -8.005)"><g id="Group_133" data-name="Group 133" transform="translate(6 8.005)"><path id="Path_44" d="M12.172 9.219a7.1 7.1 0 0 0-2.71-1.7 4.122 4.122 0 1 0-4.665 0A7.141 7.141 0 0 0 0 14.26h1.114a6.016 6.016 0 1 1 12.032 0h1.114a7.084 7.084 0 0 0-2.088-5.041zM7.13 7.13a3.008 3.008 0 1 1 3.008-3.008A3.011 3.011 0 0 1 7.13 7.13z" class="cls-ww-1" data-name="Path 44"/></g></g></svg></p>
        <span>Mi cuenta</span>
      </li>
      <li class="tab_wishlist" data="wishlist" redirect="">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="17.1" height="15.258" viewBox="0 0 17.1 15.258"><defs><style>.cls-heart-1{fill:#fff;stroke:#fff;stroke-width:.4px}</style></defs><path id="heart" d="M8.35 14.858a.979.979 0 0 1-.646-.243 182.95 182.95 0 0 0-1.9-1.633 35.318 35.318 0 0 1-4.148-3.894A6.216 6.216 0 0 1 0 5.019a5.22 5.22 0 0 1 1.325-3.565A4.491 4.491 0 0 1 4.665 0a4.2 4.2 0 0 1 2.624.906A5.368 5.368 0 0 1 8.35 2.014 5.369 5.369 0 0 1 9.411.906 4.2 4.2 0 0 1 12.035 0a4.491 4.491 0 0 1 3.341 1.454A5.22 5.22 0 0 1 16.7 5.019a6.215 6.215 0 0 1-1.656 4.069 35.31 35.31 0 0 1-4.144 3.891c-.575.49-1.226 1.045-1.9 1.636a.98.98 0 0 1-.65.243zM4.665.978a3.523 3.523 0 0 0-2.621 1.139 4.246 4.246 0 0 0-1.066 2.9A5.23 5.23 0 0 0 2.41 8.464a34.755 34.755 0 0 0 4.028 3.771c.576.491 1.229 1.047 1.909 1.642.684-.6 1.338-1.153 1.915-1.645a34.761 34.761 0 0 0 4.027-3.771 5.231 5.231 0 0 0 1.431-3.445 4.246 4.246 0 0 0-1.066-2.9A3.523 3.523 0 0 0 12.035.978a3.244 3.244 0 0 0-2.026.7 4.747 4.747 0 0 0-1.128 1.308.618.618 0 0 1-1.061 0A4.743 4.743 0 0 0 6.691 1.68 3.244 3.244 0 0 0 4.665.978zm0 0" class="cls-heart-1" transform="translate(.2 .2)"/></svg></p>
        <span>Mi lista de deseos</span>
      </li>
      <li class="tab_cart" data="cart" redirect="<?php echo site_url();?>/carrito">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="21.642" height="19.067" viewBox="0 0 21.642 19.067"><defs><style>.cls-cart-1{stroke:white;stroke-width:.4px}</style></defs><g id="shopping-cart" transform="translate(.2 .2)"><path id="Path_72" d="M6.843 12.445h11.284a.622.622 0 0 0 .6-.451l2.489-8.711a.622.622 0 0 0-.6-.793H5.408l-.445-2A.622.622 0 0 0 4.355 0H.622a.622.622 0 1 0 0 1.244h3.234L6.1 11.354a1.866 1.866 0 0 0 .741 3.579h11.286a.622.622 0 1 0 0-1.244H6.844a.622.622 0 0 1 0-1.244zm12.948-8.712L17.658 11.2H7.343L5.684 3.733zm0 0" class="cls-cart-1" data-name="Path 72"/><path id="Path_73" d="M150 361.867a1.867 1.867 0 1 0 1.867-1.867 1.869 1.869 0 0 0-1.867 1.867zm1.867-.622a.622.622 0 1 1-.622.622.623.623 0 0 1 .622-.623zm0 0" class="cls-1" data-name="Path 73" transform="translate(-143.778 -345.067)"/><path id="Path_74" d="M362 361.867a1.867 1.867 0 1 0 1.867-1.867 1.869 1.869 0 0 0-1.867 1.867zm1.867-.622a.622.622 0 1 1-.622.622.623.623 0 0 1 .622-.623zm0 0" class="cls-cart-1" data-name="Path 74" transform="translate(-346.984 -345.067)"/></g></svg></p>
        <span>Cart</span>
      </li>
    </ul>
  </div>
  <div class="ModalLeft__tab_content">
    <div class="ModalLeft__tab_content__item" id="perfil">
      <div class="ModalLeft__content">
          <?php echo do_shortcode('[woocommerce_my_account]'); ?>
      </div>
    </div>
    <div class="ModalLeft__tab_content__item" id="wishlist">
      <div class="ModalLeft__content">
          <?php echo do_shortcode('[yith_wcwl_wishlist]'); ?>
      </div>
    </div>
    <div class="ModalLeft__tab_content__item" id="cart">
      <div class="ModalLeft__content">
...
(function($) {
    $(document).ready(function(){
        console.log("ღ Yarpay ღ \n Dev con Amor por wampy para Yarpay");
    });
})( jQuery );     
</script>
